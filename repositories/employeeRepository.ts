...
// Get all employees
export async function getAllEmployeesRepo(server: FastifyInstance, employerId: number, name?: string) {
...
// Get employee by ID
export async function getEmployeeByIdRepo(server: FastifyInstance, id: number, employerId: number) {
...
// Create new employee
export async function createEmployeeRepo(server: FastifyInstance, employee: any) {
  const { rows } = await server.pg.query(
...
// Update employee
export async function updateEmployeeRepo(server: FastifyInstance, id: number, employerId: number, employeeData: any) {
  const { rows } = await server.pg.query(
    `UPDATE employees 
...
export async function deleteEmployeeRepo(server: FastifyInstance, id: number, employerId: number) {
